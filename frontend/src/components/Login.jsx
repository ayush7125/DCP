...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#0f2027] via-[#2c5364] to-[#232526]">
      ...
      >
        <h2 className="text-3xl font-extrabold text-center mb-6 bg-gradient-to-r from-[#b993e6] via-[#7ed6df] to-[#f6e58d] bg-clip-text text-transparent">Login to DC Portal</h2>
        ...
        <div className="text-center mt-4 text-white/80">
          Don't have an account? <Link to="/signup" className="text-[#b993e6] font-semibold hover:underline">Sign Up</Link>
        </div>
      </motion.div>
    </div>
  );
